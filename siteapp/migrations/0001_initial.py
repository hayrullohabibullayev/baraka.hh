# Generated by Django 4.0.2 on 2022-03-25 05:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_price', djmoney.models.fields.MoneyField(decimal_places=1, default_currency='USD', max_digits=27)),
        ...
        migrations.CreateModel(
            name='User_profil_Create',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emeail_adress', models.EmailField(max_length=254)),
